...
@Component({
  selector: 'app-list-company-employee',
  templateUrl: './list-company-employee.component.html',
  styleUrls: ['./list-company-employee.component.scss'],
...
export class ListCompanyEmployeeComponent implements OnInit {
